...
\setbeamercolor{alerted text}{fg=GIBM}
\setbeamercolor{progress bar}{fg=LetterColorL, bg=LetterColor}
\setbeamercolor{frametitle}{bg=GIBM}
...
\titlegraphic{\hfill\includegraphics[height=1.5cm]{GIBM.png}}
...
\includegraphics[scale=0.2]{GIBM_backgroung.jpg}
\end{picture}
}%
